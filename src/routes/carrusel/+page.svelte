...
<div class="container my-24 px-6 mx-auto">
	...
	<section class="mb-32 text-gray-800 text-center lg:text-left">
		<h2 class="text-3xl font-semibold mb-1o text-center">Nuevos Box</h2>
		<div class="grid lg:grid-cols-3 gap-x-6">
			<div class="mb-12 lg:mb-0">
				...
				>
					<img src="./images/IMG_3272-G.jpg" class="w-full" />
					<a href="/">
						<div
				...
				<div
					class="mb-3 text-red-600 font-medium text-sm flex items-center justify-center lg:justify-start"
				>
			...
			<div class="mb-12 lg:mb-0">
				<div
					...
					data-mdb-ripple-color="light"
				>
					<img src="./images/IMG_3269-G.jpg" class="w-full" />
					<a href="/">
						<div
							class="mask absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed opacity-0 transition duration-300 ease-in-out hover:opacity-100"
							style="background-color: rgba(251, 251, 251, 0.2)"
				...
				<div
					class="mb-3  font-medium text-sm flex items-center justify-center lg:justify-start"
				>
			...
			<div class="mb-0">
				<div
					...
					data-mdb-ripple-color="light"
				>
					<img src="./images/IMG_3270-G.jpg" class="w-full" />
					<a href="/">
						<div
							class="mask absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed opacity-0 transition duration-300 ease-in-out hover:opacity-100"
							style="background-color: rgba(251, 251, 251, 0.2)"
				...
				<div
					class="mb-3 text-yellow-500 font-medium text-sm flex items-center justify-center lg:justify-start"
				>
				...
				<p class="text-gray-500">
					Curabitur tristique, mi a mollis sagittis, metus felis mattis arcu, non vehicula nisl dui
					quis diam. Mauris ut risus eget massa volutpat feugiat. Donec.
				</p>
			</div>
		</div>
	</section>
